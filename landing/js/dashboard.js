(function () {
  ...
  const courseHy = {
    "ai-explorers": ["ԱԲ բացահայտողներ", "Ավարտական դասարանների և քոլեջների ուսանողներ", "Բացահայտեք ԱԲ-ը, կրթական ուղղությունները և փոփոխվող կարիերայի հնարավորությունները։"],
