...
if len(sys.argv) > 1:
    ...
    for resource in ['course.html', 'js/course-access.js', 'js/explorers-learning.js', 'styles/explorers-learning.css', 'js/explorers-visuals.js', 'styles/explorers-teaching.css', 'js/explorers-overview.js', 'styles/explorers-overview.css', 'content/explorers/overview.json'] + [f'assets/explorers/chapter-{i:02}.png' for i in range(1, 9)]:
